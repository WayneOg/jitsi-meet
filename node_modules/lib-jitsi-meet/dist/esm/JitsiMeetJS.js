...
const JitsiMeetJS = {
    ...
    init(options = {}) {
        ...
        const { analytics: { rtcstatsStoreLogs, rtcstatsLogFlushSizeBytes } = {} } = options;
     ...
     */
    async joinConference(roomName, appId = '', token = null, options = {}) {
        ...
        function cleanupListeners() {
            conn.removeEventListener(JitsiConnectionEvents.CONNECTION_ESTABLISHED, onConnectionEstablished);
            conn.removeEventListener(JitsiConnectionEvents.CONNECTION_FAILED, onConnectionFailed);
        }
        ...
        conn.addEventListener(JitsiConnectionEvents.CONNECTION_ESTABLISHED, onConnectionEstablished);
        conn.addEventListener(JitsiConnectionEvents.CONNECTION_FAILED, onConnectionFailed);
