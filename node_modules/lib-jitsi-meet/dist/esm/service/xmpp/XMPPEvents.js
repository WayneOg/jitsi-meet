...
(function (XMPPEvents) {
    ...
    */
     ...
     * desktop share.
     */
    XMPPEvents["DESKTOP_MUTED_BY_FOCUS"] = "xmpp.desktop_muted_by_focus";
     ...
     */
    XMPPEvents["FILE_SHARING_EVENT"] = "xmpp.files-sharing.event";
    /**
     * Event emitted when a list file is received in the conference.
     */
    XMPPEvents["FILE_SHARING_FILES_RECEIVED"] = "xmpp.files-sharing.list";
    /**
     * Event emitted when a file is added to the conference.
     */
    XMPPEvents["FILE_SHARING_FILE_ADDED"] = "xmpp.files-sharing.add";
    /**
     * Event emitted when a file is removed from the conference.
     */
    XMPPEvents["FILE_SHARING_FILE_REMOVED"] = "xmpp.files-sharing.remove";
     ...
     */
    XMPPEvents["POLLS_ANSWER_EVENT"] = "xmpp.polls.answer.event";
    /**
     * Event fired when we receive a message for polls.
     */
    XMPPEvents["POLLS_EVENT"] = "xmpp.polls.event";
    /**
     * Event fired when we received a poll or polls history event (old-polls).
     */
    XMPPEvents["POLLS_RECEIVE_EVENT"] = "xmpp.polls.received.event";
