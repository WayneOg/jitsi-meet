...
export default class JingleConnectionPlugin extends ConnectionPlugin {
    ...
    onJingle(iq) {
        ...
        switch (action) {
            case 'session-initiate': {
                ...
                sess
                    = new JingleSessionPC(sid, iq.getAttribute('to'), fromJid, this.connection, this.mediaConstraints, cloneDeep(pcConfig), isP2P, 
                    /* initiator */ false);
    ...
    getStunAndTurnCredentials() {
        ...
        this.connection.sendIQ($iq({ to: this.xmpp.options.hosts.domain,
            type: 'get' })
            .c('services', { xmlns: 'urn:xmpp:extdisco:2' }), v2Res => this.onReceiveStunAndTurnCredentials(v2Res), error => {
            ...
            this.connection.sendIQ($iq({ to: this.xmpp.options.hosts.domain,
                type: 'get' })
                .c('services', { xmlns: 'urn:xmpp:extdisco:1' }), v1Res => this.onReceiveStunAndTurnCredentials(v1Res), err => {
